...
AL_CRITERIA = [
    {"id": "al_c1", "name": "أداء الواجبات الوظيفية", "percentage": 10, "order": 1},
    {"id": "al_c2", "name": "التفاعل مع المجتمع المهني", "percentage": 10, "order": 2},
    {"id": "al_c3", "name": "التفاعل مع أولياء الأمور", "percentage": 10, "order": 3},
    {"id": "al_c4", "name": "التنويع في استراتيجيات التدريس", "percentage": 5, "order": 4},
    {"id": "al_c5", "name": "تحسين نتائج المتعلمين", "percentage": 5, "order": 5},
    {"id": "al_c6", "name": "إعداد وتنفيذ خطة التعلم", "percentage": 5, "order": 6},
    {"id": "al_c7", "name": "توظيف تقنيات ووسائل التعلم المناسبة", "percentage": 5, "order": 7},
    {"id": "al_c8", "name": "تهيئة البيئة التعليمية", "percentage": 5, "order": 8},
    {"id": "al_c9", "name": "الإدارة الصفية", "percentage": 5, "order": 9},
    {"id": "al_c10", "name": "تحليل نتائج المتعلمين وتشخيص مستوياتهم", "percentage": 5, "order": 10},
    {"id": "al_c11", "name": "تنوع أساليب التقويم", "percentage": 10, "order": 11},
    {"id": "al_c12", "name": "إعداد خطة مزمنة ومعتمدة لبرامج وفعاليات النشاط الطلابي", "percentage": 10, "order": 12},
    {"id": "al_c13", "name": "تهيئة البيئة المدرسية للبرامج والأنشطة الطلابية", "percentage": 5, "order": 13},
    {"id": "al_c14", "name": "يدعم المتعلمين وفق احتياجاتهم وميولهم للأنشطة", "percentage": 5, "order": 14},
    {"id": "al_c15", "name": "يحفز المتعلمين على المشاركة في الأنشطة المدرسية", "percentage": 10, "order": 15},
]
