...
PRINCIPAL_CRITERIA = [
    {"id": "pri_c1", "name": "المرونة والتكيف مع ظروف العمل المختلفة", "order": 1, "weight": 5},
    {"id": "pri_c2", "name": "دعم المبادرات النوعية", "order": 2, "weight": 10},
    {"id": "pri_c3", "name": "اتخاذ إجراءات تربوية لتحقيق الانضباط المدرسي", "order": 3, "weight": 5},
    {"id": "pri_c4", "name": "إدارة الموارد المدرسية بكفاءة", "order": 4, "weight": 5},
    {"id": "pri_c5", "name": "المشاركة في إعداد خطط التطوير المهني", "order": 5, "weight": 5},
    {"id": "pri_c6", "name": "الإسهام في تحسين مستوى أداء المدرسة", "order": 6, "weight": 5},
    {"id": "pri_c7", "name": "المشاركة في إعداد الخطط المدرسية", "order": 7, "weight": 5},
    {"id": "pri_c8", "name": "متابعة تنفيذ الخطط المدرسية", "order": 8, "weight": 5},
    {"id": "pri_c9", "name": "تهيئة الفرص والإمكانات لمشاركة الطلاب في الأنشطة", "order": 9, "weight": 5},
    {"id": "pri_c10", "name": "تنفيذ إجراءات عملية لتحسين نتائج التعلم", "order": 10, "weight": 5},
    {"id": "pri_c11", "name": "توظيف المنصات الرقمية في دعم التعليم والتعلم", "order": 11, "weight": 5},
    {"id": "pri_c12", "name": "متابعة تعزيز السلوك الإيجابي للطلاب", "order": 12, "weight": 5},
    {"id": "pri_c13", "name": "تهيئة بيئة مدرسية آمنة ومحفزة", "order": 13, "weight": 5},
    {"id": "pri_c14", "name": "تقديم التغذية الراجعة ومتابعة مؤشرات الأداء الوظيفي", "order": 14, "weight": 5}
]
