...
ويجب أن يتضمن بيانات أو مؤشرات أو فجوات واضحة متى أمكن.
...
[إجراءات التنفيذ]
- إجراء محدد قابل للقياس.
- إجراء مرتبط بمؤشر.
- إجراء موثق.
- إجراء يتضمن متابعة أو تقويم.

[الاستراتيجيات المستخدمة]
نص لا يتجاوز 25 كلمة (ويكون محددًا وليس عامًا).

[نقاط القوة]
نص تحليلي لا يتجاوز 25 كلمة.

[نقاط التحسين]
نص تحليلي يذكر فجوة واضحة لا يتجاوز 25 كلمة.

[التوصيات]
توصيات عملية قابلة للتنفيذ لا تتجاوز 25 كلمة.

⚠️ الالتزام بنمط التقرير المذكور أعلاه إلزامي،
ويمنع الدمج بين النمط الإداري والنمط التربوي داخل التقرير الواحد.
