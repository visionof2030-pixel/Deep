...
[ الاهداف الاشرافية]
(اكتب هنا هدفاً إشرافياً واحداً واضحاً، مرتبطاً بمؤشر قابل للقياس، لا يتجاوز 25 كلمة)

[الاجراءات]
- (إجراء أول محدد مع ذكر العدد أو النسبة، مثل: تم تنفيذ 3 زيارات صفية)
- (إجراء ثاني مع ذكر الأداة المستخدمة، مثل: تم تطبيق استبانة على 30 معلماً)
- (إجراء ثالث مع ذكر الزمن، مثل: تم عقد اجتماع لمدة ساعتين)

[مستوى الاداء]
(صف مستوى الأداء الحالي مدعوماً برقم. مثال: بلغ متوسط درجات الطلاب 82% في اختبار الشهر الأول، وهو أعلى من المستهدف 75%)

[الاستراتيجيات المستخدمة]
(اذكر الاستراتيجيات التعليمية أو الإشرافية التي تم تطبيقها، مع ذكر نسب المشاركة أو التطبيق إن أمكن)

[جوانب التميز ]
(أبرز النقاط الإيجابية مع ذكر تحسن رقمي. مثال: ارتفعت نسبة التفاعل من 45% إلى 78% بعد تطبيق الإستراتيجية)

[مجالات التحسين]
(حدد الفجوات الرقمية. مثال: لا تزال فجوة التحصيل في الرياضيات 15% عن المستهدف)

[التوصيات]
(توصيات عملية مرتبطة بأرقام وزمن. مثال: تنفيذ برنامج علاجي لمدة 4 أسابيع يستهدف 30 طالباً)
