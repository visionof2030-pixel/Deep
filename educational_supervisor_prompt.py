...
# ==========================================================
# قالب المشرف التربوي (نسخة متوازنة)
# ==========================================================

SUPERVISOR_ANALYTICAL_TEMPLATE = """
نمط التقرير: {report_mode}

اكتب تقريراً إشرافياً متكاملاً حول "{report_name}"، مستوفياً جميع الأقسام التالية. اكتب كل عنوان بين قوسين [] كما هو، ثم اكتب محتوى واضحاً ومحدداً تحته. استخدم أرقاماً ونسباً كلما أمكن.
...
[ الاهداف الاشرافية]
(ضع هدفاً واضحاً وقابلاً للقياس، مثال: "رفع نسبة إتقان القراءة لدى طلاب الصف الثالث من 65% إلى 80% بنهاية الفصل".)

[الاجراءات]
(اذكر 3-4 إجراءات قمت بها: زيارات، اجتماعات، ورش، تحليل بيانات، متابعات. مثال: "تم تنفيذ 3 زيارات صفية، عقد ورشة عمل لمدة ساعتين، تحليل نتائج 45 طالباً".)

[مستوى الاداء]
(صف مستوى الأداء الحالي بناءً على ملاحظاتك أو بياناتك. مثال: "بلغ متوسط أداء الطلاب 75% في المهارات الأساسية".)

[الاستراتيجيات المستخدمة]
(اذكر الاستراتيجيات التعليمية أو الإشرافية المطبقة. مثال: "استخدمت التعلم التعاوني في 60% من الحصص، والتقويم التكويني في جميع الحصص".)

[جوانب التميز ]
(أبرز الإيجابيات والنجاحات. مثال: "تميز 3 معلمين في تنويع الأنشطة، وارتفعت مشاركة الطلاب".)

[مجالات التحسين]
(حدد نقاط الضعف أو الفجوات. مثال: "لا تزال 20% من الطلاب بحاجة لدعم إضافي في القراءة".)

[التوصيات]
(قدم توصيات عملية قابلة للتنفيذ. مثال: "تنظيم برنامج تقوية لمدة 4 أسابيع للطلاب المتعثرين".)

⚠️ تعليمات:
- لا تترك أي عنوان فارغاً.
- حاول استخدام أرقام حقيقية لتقوية التقرير.
- اجعل الأسلوب مهنياً وواقعياً.
"""

# تعيين القوالب الأخرى للإشارة إلى نفس القالب
