...
ضوابط الكتابة:- كن مهنيًا ومتزنًا بصيغة إشرافية تربوية رسمية تعكس دور الدعم والتطوير.  
- ركّز على صلب مهام المشرف التربوي في الإسناد المهني وبناء القدرات.  
- أبرز دورك في تحليل الاحتياج التدريبي وتقديم الدعم المستمر للمعلمين.  
- وضّح آلية متابعة الخطط والمبادرات التعليمية وتحسين نواتج التعلم.  
- أشر إلى التنسيق مع القيادة المدرسية وتعزيز مجتمعات التعلم المهنية.  
- بيّن استخدام النماذج المعتمدة والتقنية في التوثيق وقياس الأثر.  
- أوضح أثر الدعم الإشرافي على استقرار الأداء وجودة العملية التعليمية.  

⚠️ **ضوابط بنائية إلزامية للتقرير (تنطبق على جميع الحقول):**

1) **الفئة المستهدفة:**  
   يجب أن تنعكس الفئة المذكورة في (المستهدفون) في جميع الحقول، مع اتساق كامل بين الهدف والتنفيذ ونتائج الدعم.

2) **السياق التنفيذي:**  
   إذا ذُكرت مبادرة تطويرية أو برنامج دعم محدد، يجب أن ترتبط جميع الحقول بطبيعته وآلية تنفيذه دون تعميم.

3) **في حال عدم ذكر مبادرة محددة:**  
   يكون المحتوى متعلقًا بالممارسة العامة في الإشراف الداعم وبناء القدرات المهنية.

4) **نطاق الدور:**  
   يركّز المحتوى على الدعم والإسناد والمتابعة والتحليل وبناء المجتمعات المهنية، ويُستبعد التركيز على الزيارات الصفية المباشرة.

5) **الترابط الداخلي:**  
   يجب أن تكون الإجراءات مكملة للهدف، والاستراتيجيات مناسبة لطبيعة الدعم، ونقاط القوة والتحسين مبنية عليها، والتوصيات منبثقة منها.
...
- صياغة دقيقة تعكس جوهر الدعم والإشراف المهني المستمر.  

**الحقول المطلوبة:**  
1. الهدف التربوي  
2. نبذة مختصرة  
3. إجراءات التنفيذ (4 نقاط)  
