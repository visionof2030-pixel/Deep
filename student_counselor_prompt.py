...
SG_CRITERIA = [
    {"id": "sg_c1", "name": "أداء الواجبات الوظيفية", "percentage": "20%", "order": 1},
    {"id": "sg_c2", "name": "التفاعل مع المجتمع المهني", "percentage": "5%", "order": 2},
    {"id": "sg_c3", "name": "التفاعل مع أولياء الأمور", "percentage": "5%", "order": 3},
    {"id": "sg_c4", "name": "يقدم التدخلات المناسبة لتعزيز الانضباط", "percentage": "5%", "order": 4},
    {"id": "sg_c5", "name": "تقديم برامج تربوية لتعزيز دافعية الطلبة للتعلم", "percentage": "5%", "order": 5},
    {"id": "sg_c6", "name": "اعداد خطة لبرامج التوجيه الطلابي", "percentage": "10%", "order": 6},
    {"id": "sg_c7", "name": "يصنف الحالات ويقدم برامج الداعم المناسبة", "percentage": "10%", "order": 7},
    {"id": "sg_c8", "name": "يعزز القيم والسلوكيات للمتعلمين", "percentage": "10%", "order": 8},
    {"id": "sg_c9", "name": "يقدم التدخلات النفسية والاجتماعية", "percentage": "10%", "order": 9},
    {"id": "sg_c10", "name": "يساعد المتعلمين على التخطيط المهني والتعليمي", "percentage": "5%", "order": 10},
    {"id": "sg_c11", "name": "يعزز التفوق الدراسي", "percentage": "5%", "order": 11},
    {"id": "sg_c12", "name": "يقدم تدخلات تربوية للمتأخرين دراسياً والمعيدين", "percentage": "5%", "order": 12},
    {"id": "sg_c13", "name": "توعية المتعلمين وأولياء امورهم بقواعد السلوك والمواظبة", "percentage": "5%", "order": 13},
]
