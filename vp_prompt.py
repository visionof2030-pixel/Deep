...
VP_CRITERIA = [
    ...
    {"id": "vp_c8", "name": "يشارك في إعداد خطة للتطوير المهني", "percentage": 5, "order": 8},
    {"id": "vp_c9", "name": "يقدم التغذية الراجعة ويتابع تحقق مؤشرات الأداء الوظيفي", "percentage": 5, "order": 9},
    {"id": "vp_c10", "name": "يدعم تنفيذ برامج التطوير المهني", "percentage": 5, "order": 10},
    {"id": "vp_c11", "name": "يقيم أداء منسوبي المدرسة", "percentage": 5, "order": 11},
    {"id": "vp_c12", "name": "ينفذ إجراءات علمية لتحسين نتائج التعلم", "percentage": 15, "order": 12},
    {"id": "vp_c13", "name": "يسهم في تحسين مستوى أداء المدرسة", "percentage": 5, "order": 13},
    {"id": "vp_c14", "name": "يشارك في إعداد الخطط المدرسية اللازمة", "percentage": 5, "order": 14},
    {"id": "vp_c15", "name": "يتابع تنفيذ الخطط المدرسية بمختلف أنواعها", "percentage": 5, "order": 15},
    {"id": "vp_c16", "name": "يهيئ الفرص والإمكانات الداعمة لمشاركة الطلاب", "percentage": 5, "order": 16},
    {"id": "vp_c17", "name": "يوظف المنصات الرقمية وتطبيقاتها المعتمدة", "percentage": 5, "order": 17},
    {"id": "vp_c18", "name": "يتابع تعزيز السلوك الإيجابي للطلاب", "percentage": 5, "order": 18},
    {"id": "vp_c19", "name": "يهيئ بيئة مدرسية آمنة ومحفزة على التعلم", "percentage": 5, "order": 19},
]
